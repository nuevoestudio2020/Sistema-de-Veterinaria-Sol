    ...
    public partial class Fichas : Form
    {
        ...
        private void txtBusqueda_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                sql_con.Open();
                sql_cmd = sql_con.CreateCommand();
                string CommandText = "select Ficha, Observaciones from ficha where Ficha like ('" + txtBusqueda.Text + "%')";
        ...
        private void btnAgregar_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string txtQuery = "insert into ficha (Ficha, Observaciones) values('" + txtFicha.Text + "', '" + txtObservaciones.Text + "') ";
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                string txtQuery = "delete from ficha where Ficha = '" + txtFicha.Text + "'";
                ExecuteQuery(txtQuery);
                LoadData();
