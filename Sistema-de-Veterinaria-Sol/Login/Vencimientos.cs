    ...
    public partial class Vencimientos : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sql_con.Open();
                sql_cmd = sql_con.CreateCommand();
                string CommandText = "select Apellido, Telefono, Animal, Quint, Sept, Tripfel, Antirrab, Antic from clientes where Quint or Sept or Tripfel or Antirrab or Antic between '" + dateTimePicker1.Text + "' and '" + dateTimePicker2.Text + "' ";
